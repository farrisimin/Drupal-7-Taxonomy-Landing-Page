...
foreach ($green_grades_data['grade_subject'] as $grade_subject_key => $grade_subject_val) {
  ...
  if (isset($green_grades_data['topic'][$grade_subject_val->tid]) && !empty($green_grades_data['topic'][$grade_subject_val->tid])) {
    ...
    if ($total_sub_sec_blocks == 0) {
      $subject_width = (242 * count($green_grades_data['topic'][$grade_subject_val->tid])) + count($green_grades_data['topic'][$grade_subject_val->tid]);
    } else {
      $subject_width = (242 * $total_sub_sec_blocks) + count($green_grades_data['topic'][$grade_subject_val->tid]);
    }
  } else {
    $subject_width = 940;
  }
...
if (isset($green_grades_data['grade_subject']) && !empty($green_grades_data['grade_subject'])) {
  ...
  foreach ($green_grades_data['grade_subject'] as $grade_subject_key => $grade_subject_val) {
    ...
    if (isset($green_grades_data['topic'][$grade_subject_val->tid]) && !empty($green_grades_data['topic'][$grade_subject_val->tid])) {
      ...
      if ($total_sub_sec_blocks == 0) {
        $subject_width = (240 * count($green_grades_data['topic'][$grade_subject_val->tid])) + count($green_grades_data['topic'][$grade_subject_val->tid]);
      } else {
        $subject_width = (240 * $total_sub_sec_blocks) + count($green_grades_data['topic'][$grade_subject_val->tid]);
      }
    } else {
      $subject_width = 940;
    }
...
//			$params['grade'] = $green_grades_data['grade_data']->tid;
            ...
            print l($link_text, 'taxonomy/term/' . $grade_subject_val->tid, array('html' => TRUE, 'query' => $params, 'attributes' => array(
//					'title' => $grade_val_val->name
                            )));
            ?>
              ...
              <?php if (isset($green_grades_data['topic'][$grade_subject_val->tid]) && !empty($green_grades_data['topic'][$grade_subject_val->tid])) { ?>
                ...
                foreach ($green_grades_data['topic'][$grade_subject_val->tid] as $topic_key => $topic_val) {
                  if (isset($green_grades_data['sub_topic'][$topic_val->tid]) && !empty($green_grades_data['sub_topic'][$topic_val->tid])) {
                    $ts_width = (238 * count($green_grades_data['sub_topic'][$topic_val->tid])) + count($green_grades_data['sub_topic'][$topic_val->tid]);
...
$link_text .= '<div style="width:"'.$ts_width.'"px;" class="new-flag"><span style="width:"'.$ts_width.'"px; margin-left:"'.$margin_left.'"px;" class="new-txt">NEW</span></div>';
          ...
          <div>
                  ...
                  <div class="fiveStarBlockSub">'.$interactive_val['fivestar'].'</div>
							</div>
...
//						  $params['subject'] = $quiz_val['nid'];
							...
							<div class="fontWhite standard_section_quiz section_head_area">
              <div class="cover_grade">
				  <div class="cover-image-container">
				  <div class="cover-outer-align">
				  <div class="cover-inner-align">
          ...
          <div>
                  ...
                  <div class="fiveStarBlockSub">'.$quiz_val['fivestar'].'</div>
							</div>
						  </div>';
					  ...
					  elseif (isset($green_grades_data['sub_topic'][$topic_val->tid]) && !empty($green_grades_data['sub_topic'][$topic_val->tid])) {
                        foreach ($green_grades_data['sub_topic'][$topic_val->tid] as $sub_topic_key => $sub_topic_val) {
                          ?>
                          <div class="marginTB5 font_7 make_relative flL" style="width: 238px; margin-right:1px;">
                          <?php
                          $params = array();
//						  $params['subject'] = $sub_topic_val->tid;
                          $sub_topic_title = (strlen($sub_topic_val->name) > 200) ? mb_substr($sub_topic_val->name, 0, 200, 'utf-8'). '..' : $sub_topic_val->name;
                          ...
                          ?>
                            ...
                            if (isset($green_grades_data['interactive_data'][$sub_topic_val->tid]) && !empty($green_grades_data['interactive_data'][$sub_topic_val->tid])) {
                              ...
                              foreach ($green_grades_data['interactive_data'][$sub_topic_val->tid] as $interactive_key => $interactive_val) {
                                ...
                                $params = array();
//						  $params['subject'] = $interactive_val['nid'];
                                $link_text = '<div class="marginTB5 font_7 make_relative" style="width: 240px;">';
if ($interactive_val['is_new']) {
	$link_text .= '<div style="width:240px;" class="new-flag"><span style="width:240px; margin-left:219px;" class="new-txt">NEW</span></div>';
}
				$link_text .= '<div class="fontWhite standard_section_sub section_head_area">
              <div class="cover_grade">
				  <div class="cover-image-container">
				  <div class="cover-outer-align">
				  <div class="cover-inner-align">
...
$link_text .= '<div style="width:240px;" class="new-flag"><span style="width:240px; margin-left:219px;" class="new-txt">NEW</span></div>';
				...
				$link_text .= '<div class="fontWhite standard_section_quiz_sub section_head_area">
              <div class="cover_grade">
				  <div class="cover-image-container">
				  <div class="cover-outer-align">
				  <div class="cover-inner-align">
